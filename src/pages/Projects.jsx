...
function Projects() {
  ...
  return (
    <>
      {loading && <ProjectsLoader untilReady={!videoReady ? true : false} />}
      <div className={`projects-page${pageVisible ? ' page-visible' : ''}`} style={{ backgroundColor: '#111', fontFamily: "'Bellefair', serif" }}>        <video 
          autoPlay 
          muted 
          loop 
          ...
          playsInline
          preload="auto"
          onCanPlay={(e) => { setPageVisible(true); setVideoReady(true); }}
